...
fun ReceiptScreen(
    ...
    var filteredInvoices = if (selectedReceipt != null) {
        invoices.filter { it.customerID == selectedReceipt!!.id }
    } else {
        invoices
    }
    ...
    Box(
        ...
        Column(modifier = Modifier.fillMaxSize()) {
            ...
            OutlinedTextField(
                ...
                label = { Text("Search by Invoice Number") },
                placeholder = { Text("Type invoice number") },
